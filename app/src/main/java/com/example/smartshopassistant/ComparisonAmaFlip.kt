...
class ComparisonAmaFlip : AppCompatActivity() {
    @SuppressLint("MissingInflatedId")
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_comparison_ama_flip)
                ...
                for ((index, imageUrl) in imlist.withIndex()) {
                    when (index) {
                        in 1 until imageViewIds.size -> {
                            when (index) {
                                1 -> Glide.with(this@ComparisonAmaFlip).load(imageUrl)
                                    .into(findViewById(R.id.im1))

                                2 -> Glide.with(this@ComparisonAmaFlip).load(imageUrl)
                                    .into(findViewById(R.id.im3))

                                3 -> Glide.with(this@ComparisonAmaFlip).load(imageUrl)
                                    .into(findViewById(R.id.im5))

                                4 -> Glide.with(this@ComparisonAmaFlip).load(imageUrl)
                                    .into(findViewById(R.id.im7))

                                5 -> Glide.with(this@ComparisonAmaFlip).load(imageUrl)
...
//                    price1List.add(convertprice.toString())
        ...
        linearfbtn1.setOnClickListener {
            ...
            val intent = Intent(this@ComparisonAmaFlip, EcommerceActivity::class.java)
